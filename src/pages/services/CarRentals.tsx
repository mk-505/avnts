          ...
          <div className="bg-white shadow-lg rounded-lg overflow-hidden mt-12">
            <div className="p-8">
              ...
              <p className="text-gray-700 mb-6">
                ...
                fleet is hand-selected to offer you the very best. Aventis Autogroup ensures that every drive
                feels exceptional, whether for business, pleasure, or passion.
              </p>
              
              <div className="bg-gray-50 p-6 rounded-lg mb-8">
                <h3 className="font-bold text-xl mb-4">Why Aventis Rentals?</h3>
